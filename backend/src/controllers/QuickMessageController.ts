...
import { head } from "lodash"; //Adicionado
...
// adicionado media respostas rápidas
export const mediaUpload = async (
  ...
  try {
    ...
    if (!quickmessage) {
      throw new AppError("QuickMessage não encontrado.");
    }

    quickmessage.mediaPath = file.filename;
    quickmessage.mediaName = file.originalname;
    const shortcode = `[${quickmessage.shortcode}]`;
